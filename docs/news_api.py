...
def get_top_headlines(country='us', category=None, sources=None, query=None, page_size=20):
    """
...
def search_articles(query, sources=None, domains=None, from_date=None, to_date=None,
...
if __name__ == "__main__":
    if NEWSAPI_KEY == 'YOUR_API_KEY':
        ...
        top_tech_headlines = get_top_headlines(country='us', category='technology', page_size=5)
        ...
        ai_articles = search_articles(query="artificial intelligence", sort_by="popularity", page_size=3) # from_date=yesterday_str
