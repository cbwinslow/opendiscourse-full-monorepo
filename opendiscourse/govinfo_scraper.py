...
logging.basicConfig(
    ...
    handlers=[logging.FileHandler("govinfo_scraper.log"), logging.StreamHandler()],
)
...
def fetch_govinfo_metadata():
    ...
    for collection in collections["collections"]:
        ...
        documents_url = (
            f"{base_url}/packages?collectionCode={collection_name}&api_key={api_key}"
        )
        ...
        for doc in documents["packages"]:
            try:
                ...
                doc_url = (
                    f"{base_url}/packages/{doc['packageId']}/summary?api_key={api_key}"
                )
